...
python ls_processor.py \
  --ls-json /Users/erkamaydin/Desktop/Python/myocr/project-2-at-2025-07-03-12-45-1e153692.json \
...
echo "yolo detect train data=dataset/data.yaml model=yolov8s.pt epochs=50 imgsz=640 batch=16" 